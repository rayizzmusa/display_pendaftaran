        ...
        default:
            ...
            if ($act == "bpjs") {
                $form = "<div class=\"form-group\">
                            ...
                            <div class=\"col-sm-4\">
                                <input type=\"text\" name=\"nomor_asuransi\" id=\"nomor-asuransi\" class=\"form-control\" readonly style=\"background-color: #f5f5f5;\" required/>
                            </div>
                        </div>";
            } else if ($act == "nonbpjs") {
                $form = "";
                                    ...
                                    <div class=\"row\">
                                        <div class=\"col-md-12\">
                                            ...
                                            <div class=\"form-group\">
                                                ...
                                                <div class=\"col-sm-4\">
                                                    <input type=\"text\" name=\"nama_pasien\" id=\"nama-pasien\" class=\"form-control\" readonly style=\"background-color: #f5f5f5;\" required/>
                                                </div>
                                            </div>
                                            $form
                                            <div class=\"form-group\">
                                                ...
                                                <div class=\"col-sm-4\">
                                                    <input type=\"text\" name=\"tgl_lahir\" id=\"tgl-lahir\" class=\"form-control\" autocomplete =\"off\" placeholder=\"yyyy-mm-dd\" readonly style=\"background-color: #f5f5f5;\" required/>
                                                </div>
                                            </div>
                                            <div class=\"form-group\">
                                                ...
                                                <div class=\"col-sm-4\">
                                                    <div class=\"col-sm-4\">
                                                        <input type=\"radio\" name=\"jenis_kelamin\" id=\"jk-laki\" value=\"1\" style=\"pointer-events:none;\" required> Laki-laki
                                                    </div>
                                                    <div class=\"col-sm-4\">
                                                        <input type=\"radio\" name=\"jenis_kelamin\" id=\"jk-perempuan\" value=\"2\" readonly style=\"pointer-events:none;\"> Perempuan
                                                    </div>
                                                </div>
                                            </div>

...
<body class="hold-transition sidebar-mini skin-blue">
    <div class="wrapper">
        ...
        <div class="content-wrapper" style='margin-left:0px !important;'>
            <section class="content">
                ...
                switch ($act) {
                    default:
                        echo "<center><h2 style=\"margin-top : 5px;\"><b>Selamat Datang</b></h2></center>";
                        ...
                        echo "    <p>Pilih jenis pendaftaran pelayanan BPJS atau Non BPJS !</p>";
                        echo "  </div>";
                        echo "</div>";
                        ...
                        <div class=\"row\">
                    <div class=\"col-md-6\">
                        <div class=\"small-box bg-aqua\" onclick=\"window.location='$default?act=bpjs'\" style=\"cursor:pointer;\">
                            <div class=\"inner\">
                                <h3>BPJS</h3>
                    ...
                    <div class=\"col-md-6\">
                        <div class=\"small-box bg-aqua\" onclick=\"window.location='$default?act=nonbpjs'\" style=\"cursor:pointer;\">
                            <div class=\"inner\">
                                <h3>Non BPJS</h3>
                                <div class=\"clearfix\"></div><br />
                            </div>
                        ...
                        break;
                    case "bpjs":
                        echo "<center><h2 style=\"margin-top : 5px;\"><b>Pelayanan BPJS</b></h2></center>";
                        include "bpjs/index.php";
                        break;

                    case "nonbpjs":
                        echo "<center><h2 style=\"margin-top : 5px;\"><b>Pelayanan Non BPJS</b></h2></center>";
                        include "nonbpjs/index.php";
                        break;
                }
                ?>
            </section>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            console.log('Bootstrap Datepicker available:', typeof $.fn.datepicker);
        ...
        function debugDatepicker() {
            ...
            console.log('Datepicker plugin loaded:', typeof $.fn.datepicker !== 'undefined');
            console.log('Elements with .datepicker class:', $('.datepicker').length);
            ...
            if ($('.datepicker').length > 0) {
                ...
                console.log('Manual datepicker initialization attempted');
            }
        }
    </script>

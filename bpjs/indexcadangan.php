            ...
            if ($ndata > 0) {
                ...
                while ($fdata2 = mysqli_fetch_assoc($result2)) {
                    ...
                    foreach ($data_praktek_per_dokter[$id_pegawai] as $data) {
                        ...
                        // tombol jam
                        $activeClass = $first ? "btn-primary active" : "btn-default";
                        $btn_jam .= "
                            <a class=\"btn $activeClass btn-jam\" 
                            data-target=\"$statusId\" 
                            data-dokter=\"$id_pegawai\">{$data['jam_praktek']}</a>
                        ";
